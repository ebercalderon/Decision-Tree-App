...
(function (F) {
  ...
  function q(a, b, d) {
    ...
    if (a)
      ...
      else if (rc(a)) for (c in a) b.call(d, a[c], c, a);
  ...
  function oa(a, b) {
    function d(a, b) {
      ...
      } else if (rc(a)) for (e in a) b[e] = c(a[e]);
  ...
  function na(a, b) {
    ...
    if (d == typeof b && "object" == d)
      if (K(a)) {
        ...
        if (Za(a) || Za(b) || Wa(a) || Wa(b) || K(b) || ha(b) || Xa(b))
          return !1;
        d = S();
        for (c in a)
          if ("$" !== c.charAt(0) && !E(a[c])) {
        ...
        for (c in b)
          if (!(c in d) && "$" !== c.charAt(0) && v(b[c]) && !E(b[c]))
            return !1;
        return !0;
      }
    return !1;
  ...
  function Ac(a, b, d) {
    ...
    F &&
      e.test(F.name) &&
      ((d.debugInfoEnabled = !0), (F.name = F.name.replace(e, "")));
  ...
  function je() {
    ...
    if (!Cc) {
      var b = rb();
      (Y = y(b) ? F.jQuery : b ? F[b] : void 0) && Y.fn.on
        ? ((G = Y),
          P(Y.fn, {
            scope: Pa.scope,
  ...
  function fb(a, b) {
    ...
    c &&
      (b
        ? delete c.data[b]
        : (c.handle && (c.events.$destroy && c.handle({}, "$destroy"), Qc(a)),
          delete gb[d],
          (a.ng339 = void 0)));
  }
  function xb(a, b) {
    ...
    b &&
      !d &&
      ((a.ng339 = d = ++Of),
      (d = gb[d] = { events: {}, data: {}, handle: void 0 }));
    return d;
  }
  function Zb(a, b, d) {
    if (Mc(a)) {
        ...
        !c.history || (h && f)
          ? (h || (w = b),
            d
              ...
              : (l.href = b),
            l.href !== b && (w = b))
          : (m[d ? "replaceState" : "pushState"](e, "", b), g(), (D = r));
        w && (w = b);
        return k;
      }
  ...
  function Ec(a, b) {
    ...
    this.$get = [
      ...
      "$animate",
      "$$sanitizeUri",
      function (a, b, c, e, n, w, ka, B, A, H) {
        function M() {
          try {
            if (!--oa) throw ((Y = void 0), ea("infchng", x));
            ka.$apply(function () {
              for (var a = 0, b = Y.length; a < b; ++a) Y[a]();
              Y = void 0;
            });
          } finally {
            oa++;
        ...
        function aa(a, b, c, d, e) {
          ...
          return function (b, c, d) {
            ...
            m ||
              (m = (d = d && d[0])
                ? "foreignobject" !== ta(d) && ja.call(d).match(/SVG/)
                  ? "svg"
                  : "html"
                : "html");
            d =
              "html" !== m
                ? G(ba(m, G("<div>").append(a).html()))
                : c
                ? Pa.clone.call(a)
                : a;
            if (g)
        ...
        function s(a, b, c, d, e, f) {
          ...
          for (var h = [], k, l, m, n, p, u = 0; u < a.length; u++) {
            ...
            (f = l.length ? Ta(l, a[u], k, b, c, null, [], [], f) : null) &&
              f.scope &&
              aa.$$addScopeClass(k.$$element);
            k =
              (f && f.terminal) || !(m = a[u].childNodes) || !m.length
                ? null
                : s(
                    m,
                    f
        ...
        function $b(a, b, c, d, e) {
          ...
          switch (a.nodeType) {
            case 1:
              Da(b, wa(ta(a)), "E", d, e);
              for (
                var l, m, n, p = a.attributes, u = 0, r = p && p.length;
                u < r;
                u++
              ) {
                var B = !1,
            ...
            case 8:
              try {
                if ((k = g.exec(a.nodeValue)))
                  (l = wa(k[1])), Da(b, l, "M", d, e) && (c[l] = V(k[2]));
              } catch (A) {}
          }
          b.sort(X);
          return b;
        ...
        function Ta(a, b, d, e, f, g, h, k, l) {
          function m(a, b, c, d) {
            if (a) {
              ...
              a.require = t.require;
              a.directiveName = M;
              if (B === t || t.$$isolateScope) a = fa(a, { isolateScope: !0 });
              h.push(a);
            }
            if (b) {
              c && (b = O(b, c, d));
              b.require = t.require;
              b.directiveName = M;
              if (B === t || t.$$isolateScope) b = fa(b, { isolateScope: !0 });
              k.push(b);
            }
          }
          function n(a, c, e, f, g) {
            ...
            B &&
              ...
              aa.$$addScopeClass(D, !0),
              (t.$$isolateBindings = B.$$isolateBindings),
              (p = ga(c, f, t, t.$$isolateBindings, B)),
              p.removeWatches && t.$on("$destroy", p.removeWatches));
            for (m in z) {
              p = r[m];
              A = z[m];
              var R = p.$$bindings.bindToController;
              A.bindingInfo =
                A.identifier && R ? ga(H, f, A.instance, R, p) : {};
              var M = A();
              M !== A.instance &&
                ((A.instance = M),
                D.data("$" + p.name + "Controller", M),
                A.bindingInfo.removeWatches && A.bindingInfo.removeWatches(),
                (A.bindingInfo = ga(H, f, A.instance, R, p)));
            }
            q(r, function (a, b) {
              var c = a.require;
              a.bindToController &&
            ...
            for (p = h.length; m < p; m++)
              (A = h[m]),
                ia(
                  ...
                  D,
                  f,
                  A.require && ib(A.directiveName, A.require, D, z),
                  N
                );
            var Fb = c;
          ...
          for (
            ...
            if ((v = t.scope))
              t.templateUrl ||
                (J(v)
                  ? (W("new/isolated scope", B || u, t, N), (B = t))
                  : W("new/isolated scope", B, t, N)),
                (u = u || t);
            M = t.name;
            if (
              !Ca &&
              ...
              for (v = C + 1; (Ca = a[v++]); )
                if (
                  (Ca.transclude && !Ca.$$tlb) ||
                  (Ca.replace && (Ca.templateUrl || Ca.template))
                ) {
                  va = !0;
                  break;
                }
            ...
            !t.templateUrl &&
              ...
              ((v = t.controller),
              (r = r || S()),
              W("'" + M + "' controller", r[M], t, N),
              (r[M] = t));
            if ((v = t.transclude))
              if (
                ((H = !0),
                t.$$tlb || (W("transclusion", A, t, N), (A = t)),
                "element" == v)
              )
                (w = !0),
                  (p = t.priority),
                  (R = N),
                  (N = d.$$element = G(aa.$$createComment(M, d[M]))),
                  (b = N[0]),
                  ca(f, ya.call(R, 0), b),
                  (R[0].$$parentNode = R[0].parentNode),
                  (ka = ac(va, R, e, p, g && g.name, {
            ...
            if (t.template)
              if (
                ...
                W("template", x, t, N),
                (x = t),
                (v = E(t.template) ? t.template(N, d) : t.template),
                (v = ra(v)),
                t.replace)
              ) {
                g = t;
            ...
            if (t.templateUrl)
              (z = !0),
                ...
                (x = t),
                t.replace && (g = t),
                (n = Z(a.splice(C, a.length - C), N, d, f, H && ka, h, k, {
              ...
              try {
                ...
                E(s)
                  ? m(null, bb(Y, s), I, Ta)
                  : s && m(bb(Y, s.pre), bb(Y, s.post), I, Ta);
              } catch (da) {
                c(da, ua(N));
              }
          ...
          if (f.hasOwnProperty(e)) {
            ...
            for (var p = 0, u = e.length; p < u; p++)
              try {
                if (
                  ((n = e[p]),
                  (y(h) || h > n.priority) && -1 != n.restrict.indexOf(g))
                ) {
                  l && (n = Sb(n, { $$start: l, $$end: m }));
                  if (!n.$$bindings) {
                    var r = n,
                      B = n,
                      A = n.name,
                      x = { isolateScope: null, bindToController: null };
                    J(B.scope) &&
                      (!0 === B.bindToController
                        ? ((x.bindToController = d(B.scope, A, !0)),
                          (x.isolateScope = {}))
                        : (x.isolateScope = d(B.scope, A, !1)));
                    J(B.bindToController) &&
                      (x.bindToController = d(B.bindToController, A, !0));
        ...
        function Z(a, b, c, d, f, g, h, k) {
          ...
          e(A).then(function (e) {
            ...
            if (B.replace) {
              ...
              u = e[0];
              if (1 != e.length || 1 !== u.nodeType)
                throw ea("tplrt", B.name, A);
              e = { $attr: {} };
              ca(d, b, u);
              var H = $b(u, [], e);
              J(B.scope) && $c(H, !0);
          ...
          return function (a, b, c, d, e) {
            ...
            b.$$destroyed ||
              (l
                ? l.push(b, c, d, a)
                : (m.transcludeOnThisElement && (a = va(b, m.transclude, e)),
                  m(n, b, c, d, a)));
          };
        }
        function X(a, b) {
            ...
            switch (e.mode) {
              ...
              case "=":
                ...
                p = e.collection
                  ...
                  : a.$watch(n(c[m], p), null, B.literal);
                k.push(p);
                break;
              case "<":
                if (!sa.call(c, m)) {
        ...
        return function (f, g, h, k) {
          ...
          if (I(f)) {
            ...
            f = a.hasOwnProperty(m)
              ? a[m]
              : Dc(g.$scope, m, !0) || (b ? Dc(c, m, !0) : void 0);
            Qa(f, m, !0);
          }
          if (h)
            return (
      ...
      function (e, f, g, h, k, l) {
        ...
        function n(c, d) {
          ...
          function l(a, c, d, e) {
            ...
            H &&
              (200 <= a && 300 > a ? H.put(R, [a, c, ed(d), e]) : H.remove(R));
          ...
          (!c.cache && !a.cache) ||
            ...
            (H = J(c.cache) ? c.cache : J(a.cache) ? a.cache : x);
          H &&
            ((M = H.get(R)),
            v(M)
              ? M && E(M.then)
                ? M.then(w, w)
                : K(M)
                ? n(M[1], M[0], fa(M[2]), M[3])
                : n(M, 200, {}, "OK")
              : H.put(R, A));
          y(M) &&
            ((M = id(c.url)
              ? f()[c.xsrfCookieName || a.xsrfCookieName]
              : void 0) && (Aa[c.xsrfHeaderName || a.xsrfHeaderName] = M),
            e(
              c.method,
              R,
              d,
        ...
        var x = g("$http");
        a.paramSerializer = I(a.paramSerializer)
    ...
    this.$get = [
      ...
      function (d, c, e) {
        ...
        function k(f, k, n, p) {
          ...
          u = f.length;
          for (var H = [], M = []; q < u; )
            if (-1 != (t = f.indexOf(a, q)) && -1 != (w = f.indexOf(b, t + l)))
              q !== t && H.push(g(f.substring(q, t))),
                (q = f.substring(t + l, w)),
                B.push(q),
                A.push(d(q, D)),
                (q = w + m),
      ...
      function (a, b, d, c, e) {
        function f(f, k, l, m) {
          ...
          t.$$intervalId = q(function () {
            ...
            0 < l &&
              r >= l &&
              (u.resolve(r), z(t.$$intervalId), delete g[t.$$intervalId]);
            D || a.$apply();
          }, k);
          g[t.$$intervalId] = u;
          return t;
  ...
  function rf() {
    ...
    this.html5Mode = function (a) {
      return Ea(a)
        ? ((b.enabled = a), this)
        : J(a)
        ? (Ea(a.enabled) && (b.enabled = a.enabled),
          Ea(a.requireBase) && (b.requireBase = a.requireBase),
          Ea(a.rewriteLinks) && (b.rewriteLinks = a.rewriteLinks),
          this)
        : b;
    };
    this.$get = [
          ...
          $digest: function () {
            ...
            do {
              ...
              a: do {
                ...
                if (
                  !(p =
                    (w.$$watchersCount && w.$$childHead) ||
                    (w !== this && w.$$nextSibling))
                )
                  for (; w !== this && !(p = w.$$nextSibling); ) w = w.$parent;
              } while ((w = p));
              if ((x || u.length) && !q--)
                throw ((D.$$phase = null), d("infdig", b, y));
            } while (x || u.length);
    ...
    this.$get = [
      ...
      function (a, b) {
        ...
        if (l) {
          ...
          !e ||
            (m && n) ||
            ((m = I(l.webkitTransition)), (n = I(l.webkitAnimation)));
        }
        return {
          history: !(!c || 4 > e || f),
          hasEvent: function (a) {
      ...
      function (b, d, c, e) {
        function f(g, h) {
          ...
          K(k)
            ...
            : k === dc && (k = null);
          return d
            .get(g, P({ cache: b, transformResponse: k }, a))
            ["finally"](function () {
              f.totalPendingRequests--;
            })
            .then(
      ...
      a.sort(function (a, b) {
        for (var c = 0, d = 0, e = g.length; d < e; ++d) {
          var c = a.predicateValues[d],
            ...
            x = 0;
          c.type === f.type
            ? c.value !== f.value && (x = c.value < f.value ? -1 : 1)
            : (x = c.type < f.type ? -1 : 1);
  ...
  var K = Array.isArray,
    ...
    Fa = function () {
      if (!v(Fa.rules)) {
        var a =
          F.document.querySelector("[ng-csp]") ||
    ...
    rb = function () {
      ...
      for (b = 0; b < d; ++b)
        if (
          ((c = Oa[b]),
          (a = F.document.querySelector("[" + c.replace(":", "\\:") + "jq]")))
        ) {
  ...
  var Tf =
    ...
    Pa = (T.prototype = {
      ready: function (a) {
        ...
        var d = !1;
        "complete" === F.document.readyState
          ? F.setTimeout(b)
          : (this.on("DOMContentLoaded", b), T(F).on("load", b));
      },
      toString: function () {
        var a = [];
        q(this, function (b) {
  ...
  q(
    {
      ...
      isolateScope: function (a) {
        return (
          G.data(a, "$isolateScope") || G.data(a, "$isolateScopeNoTemplate")
        );
      },
      controller: Rc,
      injector: function (a) {
        ...
        if (c !== Na && 2 !== c && 8 !== c)
          if (((c = L(b)), Eb[c]))
            if (v(d))
              ...
              return a[b] || (a.attributes.getNamedItem(b) || C).specified
                ? c
                : void 0;
  ...
  db.$$annotate = function (a, b, d) {
    ...
    if ("function" === typeof a) {
      if (!(c = a.$inject)) {
        ...
        if (a.length) {
          if (b)
            throw ((I(d) && d) || (d = a.name || Xf(a)), Ha("strictdi", d));
          b = Vc(a);
  ...
  s.prototype = {
    ...
    primary: function () {
      ...
      this.expect("(")
        ...
        ? (a = oa(this.selfReferential[this.consume().text]))
  ...
  td.prototype = {
    compile: function (a, b) {
      ...
      e = new Function(
        ...
        "text",
        e
      )(this.$filter, Ua, qa, nd, hg, Jb, lg, od, a);
                ...
                k.if_(
                  ...
                  function () {
                    ...
                    if (a.computed)
                      ...
                      if (k.state.expensiveChecks || Kb(a.property.name))
  ...
  ud.prototype = {
    ...
    recurse: function (a, b, d) {
      ...
      switch (a.type) {
        ...
        case s.Identifier:
          return (
            Ua(a.name, f.expression),
            f.identifier(
              a.name,
              f.expensiveChecks || Kb(a.name),
              b,
              d,
              f.expression
            )
        ...
        case s.MemberExpression:
          return (
            ...
            a.computed ||
              (Ua(a.property.name, f.expression), (e = a.property.name)),
        ...
        if (!b.href && !b.xlinkHref)
          return function (a, b) {
            if ("a" === b[0].nodeName.toLowerCase()) {
              var e =
                "[object SVGAnimatedString]" === ja.call(b.prop("href"))
                  ? "xlink:href"
                  : "href";
  ...
  var Xd = {
      ...
      "datetime-local": mb(
        "datetimelocal",
        Ud,
        Ob(Ud, "yyyy MM dd HH mm ss sss".split(" ")),
                ...
                f
                  ? (a(f, !0).then(
                      ...
                      function () {
                        c.$$destroyed ||
                          w !== q ||
                          (D(), c.$emit("$includeContentError", f));
                      }
                    ),
      ...
      function (a) {
        return {
          ...
          link: function (b, d, c, e) {
            ja.call(d[0]).match(/SVG/)
              ? (d.empty(),
                a(Nc(e.template, F.document).childNodes)(
                  b,
                  function (a) {
                    d.append(a);
                  },
      ...
      return {
        ...
        controller: [
          ...
          function (a, b) {
            ...
            v(this.$options.updateOn)
              ? ((this.$options.updateOnDefault = !1),
                (this.$options.updateOn = V(
                  this.$options.updateOn.replace(Pg, function () {
        ...
        return {
          ...
          link: {
            ...
            post: function (d, h, k, l) {
              ...
              u
                ? (z.remove(), a(z)(d), z.removeClass("ng-scope"))
                : (z = G(e.cloneNode(!1)));
              h.empty();
              n();
              ...
              a.$watchCollection(n, function (f) {
                ...
                for (g = 0; g < w; g++)
                  if (
                    ...
                    G[g] = { id: A, scope: void 0, clone: void 0 };
                    x[A] = !0;
                  }
                for (s in m) {
                  E = m[s];
                  ...
                  b.leave(A);
                  if (A[0].parentNode)
                    for (g = 0, n = A.length; g < n; g++)
                      A[g].$$NG_REMOVED = !0;
                  E.scope.$destroy();
                }
                for (g = 0; g < w; g++)
                  if (
                    ((y = f === F ? g : F[g]), (C = f[y]), (E = G[g]), E.scope)
                  ) {
                    s = r;
                    do s = s.nextSibling;
  ...
  F.angular.bootstrap
    ? F.console && console.log("WARNING: Tried to load angular more than once.")
    : (je(),
      le(da),
      da.module(
        "ngLocale",
